...
const products: Product[] = [
  ...
  },
  {
    name: "Database",
    tab: "Database",
    desc: "Flexible records your whole team — and your AI workforce — can read, filter, and update.",
    points: ["Flexible fields and views", "Filters, sorts, and groups", "Readable and writable by agents"],
    href: "/products/database",
    Icon: DatabaseIcon,
    shot: "/screenshots/half-2.png",
    alt: "Onita database with flexible records, views, and filters",
  },
  {
    name: "Documents",
    tab: "Documents",
  ...
  },
  {
    name: "Kanban",
    tab: "Kanban",
    desc: "Drag-and-drop boards for every team, with agents moving cards as work gets done.",
    points: ["Drag-and-drop boards", "Per-team workflows", "Agents move cards automatically"],
    href: "/products/kanban",
    Icon: KanbanIcon,
    shot: "/screenshots/half-5.png",
    alt: "Onita kanban board with columns and task cards",
  },
  {
    name: "Calendar",
    tab: "Calendar",
  ...
  },
  {
    name: "AI Agents",
    tab: "AI Agents",
    desc: "Employees that never sleep — with memory, knowledge, tools, and permissions of their own.",
